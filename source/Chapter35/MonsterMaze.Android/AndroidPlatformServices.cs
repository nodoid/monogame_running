...
#pragma warning restore CS0618, CA1422
    ...
    {
        long milliseconds = strength switch
        {
            HapticStrength.Light => 12,
            HapticStrength.Medium => 28,
            _ => 70
        };
        ...
        try
        {
            ...
            {
#pragma warning disable CS0618, CA1422 // VibratorService is the only option before Android 12.
                vibrator = (Vibrator)_activity.GetSystemService(Context.VibratorService);
#pragma warning restore CS0618, CA1422
            }
        ...
        {
            // Some devices and emulators have no vibrator; that is fine.
        }
    }
}
