...
public sealed class Player
{
    ...
    /// <summary>True once the player has walked out through the exit.</summary>
...
#if CH15
                bool canMove = _maze.CanMove(Cell, direction) || _maze.IsExitStep(Cell, direction);
#else
